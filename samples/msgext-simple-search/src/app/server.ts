...
import { CustomerActivityHandler } from "./customerActivityHandler/customerActivityHandler";
...
// Set up the Customer activity handler
// Register and load the activity handler (bot)
const botAdapter = new BotFrameworkAdapter({
    appId: process.env.MICROSOFT_APP_ID,
    appPassword: process.env.MICROSOFT_APP_PASSWORD
});

// Deal with unhandled errors in activity handler
...
// Set up the API endpoint for the activity handler
const bot = new CustomerActivityHandler();
